 ...
 *   id = "spo_product_display",
 *   label = @Translation("Product Display"),
 *   default_step = "spo",
 *   wrapper_element = "container",
 * )
 */
class SpoProductDisplay extends CheckoutPaneBase implements CheckoutPaneInterface, ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    // TODO: Fetch all product display modes available.
    $options = [];
  ...
  public function buildPaneForm(array $pane_form, FormStateInterface $form_state, array &$complete_form) {
    // TODO: Display the product variation selection widget.
    $pane_form = [];
